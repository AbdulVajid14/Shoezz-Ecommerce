...
//   const metrics = [
//     { title: 'Total Sales', value: `$${totalSales?.toFixed(2) || '0.00'}`, icon: '💰', trend: '+12%' },
//     { title: 'Total Orders', value: totalOrders || 0, icon: '📦', trend: '+5%' },
//     { title: 'Total Users', value: totalUsers || 0, icon: '👥', trend: '+2%' },
//     { title: 'Total Products', value: totalProducts || 0, icon: '🛍️', trend: '+8%' },
//     { title: 'Total Profit', value: `$${totalProfit?.toFixed(2) || '0.00'}`, icon: '💹', trend: '+15%' },
//   ];
...
//           <div
//             key={index}
//             className="bg-white p-4 sm:p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow border border-gray-100"
//           >
...
//               </div>
//               <span className="text-2xl sm:text-3xl opacity-80">{metric.icon}</span>
//             </div>
//           </div>
//         ))}
//       </div>
...
//           <h3 className="text-lg sm:text-xl font-semibold mb-4">Monthly Performance</h3>
...
//                   >
//                     <td className="py-4">{order?.orderId?.slice(7, 19) || ''}</td>
//                     <td className="py-4">{order?.userName || 'Unknown'}</td>
//                     <td className="py-4">
//                       {order?.orderDate ? new Date(order.orderDate).toLocaleDateString() : 'N/A'}
//                     </td>
//                     <td className="py-4">${order?.totalAmount?.toFixed(2) || '0.00'}</td>
//                     <td className="py-4">
//                       <span
