...
//         try {
//           const response = await api.get('/products/categories/men');
  ...
  return (
    ...
    >
      ...
      <motion.div 
        ...
        className="relative mt-20 h-[400px] bg-[url('https://images.unsplash.com/photo-1463100099107-aa0980c362e6?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')] bg-cover bg-center bg-no-repeat"
      >
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-6">Men's Collection</h2>
      ...
      >
        <motion.div variants={textVariant(0.5)}>
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-800">#Mens</h2>
      ...
      >
        <div className="container mx-auto text-center px-6">
          ...
          <p className="text-xl max-w-2xl mx-auto mb-8 opacity-90">
            Our experts can help you find the perfect pair for your needs.
          </p>
          <motion.button
